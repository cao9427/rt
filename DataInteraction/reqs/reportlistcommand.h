#ifndef REPORTLISTCOMMAND_H
#define REPORTLISTCOMMAND_H

#include "basefiledowncommandctx.h"
#include "tools/hydatasetparser.h"

// 查询研报列表（包含固定条件与动态条件）
class ReportListCommand : public BaseFileDownCommandCtx
{
    Q_OBJECT
public:
    ReportListCommand(const QString& qid, QObject *parent = nullptr);
